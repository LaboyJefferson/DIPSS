...
@section('content')
    ...
    <div class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center text-white" style="background-color: #3a8f66; color:#fff; font-weight: bold; ">{{ __('Add new Supplier') }}</div>
                    <div class="card-body">
                        <!-- Alert Messages -->
                        ...
                        <form method="POST" action="{{ route('store_supplier') }}" enctype="multipart/form-data">
                            @csrf
