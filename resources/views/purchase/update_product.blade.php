                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update_product', ['supplier_id' => $supplierId, 'product_id' => $product->product_id]) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="file" id="image_url" name="image_url" class="form-control @error('image_url') is-invalid @enderror"  value="{{ old('image_url', $product->image_url) }}" accept="image/*">
                                        @error('image_url')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="product_name" type="text" class="form-control @error('product_name') is-invalid @enderror" name="product_name" value="{{ old('product', $product->product_name) }}" pattern="^[a-zA-Z0-9\s\-]{1,30}$" required>
                                        @error('product_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            ...
                                            <select id="category_dropdown" class="form-select @error('category_name') is-invalid @enderror" name="category_dropdown" required>
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{ $category->category_id }}" 
                                                        @if(old('category_dropdown', $product->category_id) == $category->category_id) selected @endif>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description', $product->description ?? '') }}" pattern='^[a-zA-Z0-9\s\-\.,\/\"]{1,255}$'>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input id="purchase_price_per_unit" type="text" class="form-control @error('purchase_price_per_unit') is-invalid @enderror" name="purchase_price_per_unit" value="{{ old('purchase_price_per_unit', $inventory->purchase_price_per_unit) }}" pattern="^\d{1,6}(\.\d{1,2})?$" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="reorder_level" type="text" class="form-control @error('reorder_level') is-invalid @enderror" name="reorder_level" value="{{ old('reorder_level', $inventory->reorder_level) }}" pattern="^\d{1,6}$" required>
                                        @error('reorder_level')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
