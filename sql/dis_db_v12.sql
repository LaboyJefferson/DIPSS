...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2025 at 11:33 AM
...
(20250000, 'Jefferson', 'Laboy', NULL, NULL, '20217442@s.ubaguio.edu', '$2y$10$mCTI2YutKzT/PFUJpOZAT.vXHDdYE6RZSlFZf6.yGt4U/.2naXfL6', NULL, 'Administrator, Purchase Manager, Inventory Manager, Auditor, Salesperson', NULL, NULL, NULL, NULL, '2025-04-27 09:30:38', '2025-04-27 09:31:12', '2025-04-27 09:30:38', '2025-04-27 09:33:10');
...
--
ALTER TABLE `order_statuses`
  MODIFY `order_statuses` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `purchase_orders`
  MODIFY `purchase_order_id` int(8) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `deliveries`
  ADD CONSTRAINT `delivery_purchase_orderFK` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_orders` (`purchase_order_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `order_items_purchase_ordersFK` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_orders` (`purchase_order_id`) ON DELETE CASCADE ON UPDATE CASCADE;
