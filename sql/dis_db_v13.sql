...
INSERT INTO `order_items` (`order_items_id`, `quantity`, `price`, `purchase_order_id`, `product_id`) VALUES
(29321315, 3, 45000, 69567606, 15076522),
(36928353, 3, 45000, 13339960, 15076522),
(51996168, 3, 15000, 65143727, 18975177),
(54487926, 5, 32000, 65143727, 84495846);
...
INSERT INTO `purchase_order` (`purchase_order_id`, `type`, `payment_method`, `total_price`, `reason`, `created_by`, `supplier_id`, `order_status`) VALUES
(13339960, 'Purchasing Order', 'Cash on Delivery (COD)', 90000.00, NULL, 20250000, 88922363, 1),
(65143727, 'Purchasing Order', 'Cash on Delivery (COD)', 94000.00, NULL, 20250000, 95562004, 1),
(69567606, 'Purchasing Order', 'Cash on Delivery (COD)', 90000.00, NULL, 20250000, 88922363, 1);
...
ALTER TABLE `product`
  ...
  ADD KEY `product_supplierFK` (`supplier_id`);
...
ALTER TABLE `purchase_order`
  ...
  ADD KEY `purchase_order_supplierFK` (`supplier_id`),
...
--
ALTER TABLE `order_items`
  MODIFY `order_items_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54487927;

--
-- AUTO_INCREMENT for table `order_statuses`
--
ALTER TABLE `order_statuses`
  MODIFY `order_statuses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84495847;

--
-- AUTO_INCREMENT for table `purchase_order`
--
ALTER TABLE `purchase_order`
  MODIFY `purchase_order_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87416217;
