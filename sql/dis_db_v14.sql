...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2025 at 02:44 PM
...
(67777409, 25, 375000, NULL, 62915210, 15076522),
...
INSERT INTO `purchase_order` (`purchase_order_id`, `type`, `payment_method`, `billing_address`, `shipping_address`, `total_price`, `reason`, `created_by`, `supplier_id`, `order_status`) VALUES
(25288886, 'Purchasing Order', 'Cash on Delivery (COD)', 'Baguio City', '10 Upper Session Rd, Baguio City, Benguet', 484000.00, NULL, 20250000, 95562004, 3),
(62915210, 'Purchasing Order', 'Cash on Delivery (COD)', 'La Trinidad, Benguet', '10 Upper Session Rd, Baguio City, Benguet', 750000.00, NULL, 20250000, 88922363, 1),
(63575706, 'Purchasing Order', 'Cash on Delivery (COD)', 'La Trinidad, Benguet', '123 Session Road, Baguio City, Philippines', 300000.00, NULL, 20250000, 88922363, 3),
(92617103, 'Purchasing Order', 'Cash on Delivery (COD)', 'La Trinidad, Benguet', '10 Upper Session Rd, Baguio City, Benguet', 600000.00, NULL, 20250000, 88922363, 1);
